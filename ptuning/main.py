...
def main():
    ...
    elif model_args.use_lora_training is True:
        lora_config = LoraConfig(
            r = data_args.lora_len,
    ...
    print("outside train dataset: ", len(train_dataset))
    ...
    print("trainer_dataset_size: ", len(trainer.train_dataset))
    # Training
    if training_args.do_train:
        checkpoint = None
        ...
        if model_args.use_lora_training is True:
