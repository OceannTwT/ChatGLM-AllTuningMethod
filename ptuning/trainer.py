...
class Trainer:
    ...
    def _set_signature_columns_if_needed(self):
        if self._signature_columns is None:
            ...
            #['input_ids', 'position_ids', 'attention_mask', 'past_key_values', 'inputs_embeds', 'labels', 'use_cache', 'output_attentions', 'output_hidden_states', 'return_dict', 'labels', 'label', 'label_ids']
            #['args', 'kwargs', 'label_ids', 'label']
    ...
    def _remove_unused_columns(self, dataset: "datasets.Dataset", description: Optional[str] = None):
        ...
        print("ignored_columns_len", len(ignored_columns))
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        print("before_train_dataset_size: ", len(train_dataset))
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            step = -1
            print("lengths of epoch_iterator: ", len(epoch_iterator))
